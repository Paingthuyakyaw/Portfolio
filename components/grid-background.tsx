...
export function GridBackgroundDemo({ children }: { children: ReactNode }) {
  return (
    <div className="relative h-[80vh] w-full items-center justify-center bg-white dark:bg-black">
      <div
        className={cn(
          "absolute inset-0",
      ...
      <div className="relative h-[78vh] flex items-center z-20 text-white">
        {children}
      </div>
    </div>
  );
